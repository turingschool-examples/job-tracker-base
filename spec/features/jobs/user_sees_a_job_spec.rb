...
describe "User sees a specific job" do
  ...
  scenario "user sees how many jobs have each specific tag listed" do
    ...
    job_1 = company.jobs.create(title: "Developer", level_of_interest: 70, salary: 70000, city: "Denver")
    job_1.tags << tag_1
    job_1.tags << tag_2
    job_1.tags << tag_3

    job_2 = company.jobs.create(title: "Also Developer", level_of_interest: 50, salary: 60000, city: "Denver")
    job_2.tags << tag_1
    job_2.tags << tag_2


    job_3 = company.jobs.create(title: "Also Also Developer", level_of_interest: 20, salary: 80000, city: "Denver")
    job_3.tags << tag_1
    ...
    expect(page).to have_content( "Average Salary for Jobs with Full Stack Tags: $70,000.00 ")
  end
