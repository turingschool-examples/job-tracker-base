...
describe "User sees a specific job" do
  scenario "a user sees a job for a specific company" do
    ...
    job = company.jobs.create!(title: "Developer", level_of_interest: 70, city: "Denver", salary: 95000)
  ...
  scenario "a user sees count of how many jobs have a specific tag" do
    company = Company.create!(name: "ESPN")
    job_1 = company.jobs.create!(title: "Developer", level_of_interest: 70, city: "Denver", salary: 95000)
    job_2 = company.jobs.create!(title: "ButtMonkey", level_of_interest: 60, city: "New York", salary: 87000)
  ...
  scenario "a user sees an average salary for all jobs within a specific tag listed" do
    company = Company.create!(name: "ESPN")
    job_1 = company.jobs.create!(title: "Developer", level_of_interest: 70, city: "Denver", salary: 95000)
    job_2 = company.jobs.create!(title: "ButtMonkey", level_of_interest: 60, city: "New York", salary: 87000)
    tag_1 = Tag.create!(title: "Good Location")
    ...
    expect(page).to have_content("2")
    expect(page).to have_content("1")
    expect(page).to have_content("91000")
  end
end
