...
describe "When a visit a specific job page" do
  describe "as a user" do
    ...
    scenario "I see tags that have more than just one job" do
      ...
      within ".job-tags" do
        expect(page).to have_content("Great-company - 2 ($65,000.00)")
        expect(page).to have_content("Software - 2 ($65,000.00)")
        expect(page).to have_content("Education - 1 ($70,000.00)")
      end
    end
  end
end
