...
ActiveRecord::Schema.define(version: 20170802192655) do
  ...
  create_table "companies_locations", force: :cascade do |t|
    ...
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["company_id"], name: "index_companies_locations_on_company_id", using: :btree
    t.index ["location_id"], name: "index_companies_locations_on_location_id", using: :btree
  end
